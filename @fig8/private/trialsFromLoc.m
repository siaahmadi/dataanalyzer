...
for pathi = 1:nSessions
    ...
    labelSeq = dataanalyzer.env.fig8.fixsuccnodeseq(dataanalyzer.env.fig8.fillArmHole(locInfo(pathi).labelSeq));
    labelSeq = dataanalyzer.env.fig8.fixsuccarmseq(dataanalyzer.env.fig8.fillSeqHole(labelSeq));
