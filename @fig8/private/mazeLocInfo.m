...
for path = 1:nPaths
    ...
    [labelSeq, idxnodes] = dataanalyzer.env.fig8.fixsuccnodeseq(dataanalyzer.env.fig8.fillArmHole(labelSeq));
	[fixedLabelSeq, idxarms] = dataanalyzer.env.fig8.fixsuccarmseq(dataanalyzer.env.fig8.fillSeqHole(labelSeq));
    a = ~idxnodes;
    b = find(~idxarms);
