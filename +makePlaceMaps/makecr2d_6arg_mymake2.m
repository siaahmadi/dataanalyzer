...
if nargout > 3
	[rateMaps, binRangeX, binRangeY, gaussFit2] = cellfun(@dataanalyzer.makePlaceMaps.mymake2, ...
		spTrains, videoX, videoY, videoTS,...
		spatialRange, nBins, ...
		'UniformOutput', false);
else
	[rateMaps, binRangeX, binRangeY] = cellfun(@dataanalyzer.makePlaceMaps.mymake2, ...
		spTrains, videoX, videoY, videoTS,...
		spatialRange, nBins, ...
		'UniformOutput', false);
end